...
ax1.fill_between(x=indices,y1=percents,y2=np.zeros(len(indices)),step='mid',color='#3f965fff')
...
ax1.set_ylabel('% completed', color='white',style='italic')
